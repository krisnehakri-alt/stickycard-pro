...
export const loader = async ({ request }) => {
  ...
  try {
    ...
    switch(templateId) {
      case 'template_1':
        html = `
          <div style="background: white; padding: 24px; border-radius: 12px; width: 100%; max-width: 280px; text-align: center; box-shadow: 0 8px 24px rgba(0,0,0,0.05); box-sizing: border-box; display: block; overflow-wrap: break-word; word-break: break-word;">
      ...
      case 'template_2':
        html = `
          <div style="position: relative; overflow: hidden; border-radius: 16px; padding: 24px; width: 100%; max-width: 280px; text-align: center; background: rgba(255,255,255,0.8); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.5); box-shadow: 0 8px 32px rgba(31,38,135,0.15); z-index: 1; box-sizing: border-box; overflow-wrap: break-word; word-break: break-word;">
      ...
      case 'template_3':
        html = `
          <div style="border: 2px solid #ff007f; padding: 24px; border-radius: 12px; width: 100%; max-width: 280px; text-align: center; box-shadow: 0 0 15px rgba(255,0,127,0.3), inset 0 0 15px rgba(255,0,127,0.1); background: #0a0a0a; box-sizing: border-box; overflow-wrap: break-word; word-break: break-word;">
      ...
      case 'template_4':
        html = `
          <div style="background: #1a1a1a; border: 1px solid #d4af37; padding: 24px; border-radius: 4px; width: 100%; max-width: 280px; text-align: center; box-shadow: 0 10px 30px rgba(0,0,0,0.5); z-index: 1; box-sizing: border-box; overflow-wrap: break-word; word-break: break-word;">
      ...
      case 'template_5':
        html = `
          <div style="background: white; padding: 24px; border-radius: 16px; width: 100%; max-width: 280px; text-align: center; box-shadow: 0 20px 40px rgba(0,0,0,0.08); position: relative; box-sizing: border-box; overflow-wrap: break-word; word-break: break-word;">
      ...
      case 'template_6':
        html = `
          <div style="background: #0a0a0a; border: 1px solid #333; padding: 24px; border-radius: 8px; width: 100%; max-width: 280px; text-align: center; box-shadow: 0 15px 35px rgba(0,0,0,0.6); box-sizing: border-box; overflow-wrap: break-word; word-break: break-word;">
      ...
      case 'template_7':
        html = `
          <div style="background: rgba(0,0,0,0.4); backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px); border: 1px solid rgba(255,255,255,0.1); padding: 24px; border-radius: 12px; width: 100%; max-width: 280px; text-align: center; box-shadow: 0 20px 40px rgba(0,0,0,0.5); box-sizing: border-box; overflow-wrap: break-word; word-break: break-word;">
